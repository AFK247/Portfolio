        ...
        <div className='max-w-screen-lg m-auto mt-8'>
            {
                ...
                <div>
                    <section className='grid grid-cols-2 justify-center items-center gap-8 '>
                        <img className='hover:scale-110 duration-500 border rounded-lg p-4 w-[40vw] shadow-lg shadow-slate-600' src={isp} alt="" />
                        <img className='hover:scale-110 duration-500 border rounded-lg p-4 w-[40vw] shadow-lg shadow-slate-600' src={isp1} alt="" />
                        <img className='hover:scale-110 duration-500 border rounded-lg p-4 w-[40vw] shadow-lg shadow-slate-600' src={isp2} alt="" />
                    </section>
