        ...
        <div className="flex flex-col justify-center md:w-[60vw]">
          <h2 className="text-4xl sm:text-5xl font-bold text-white my-4">
            <TypeWriterEffect
              ...
              startDelay={2000}
              cursorColor="#3F3D56"
              multiText={["Hi, Im a MERN Web Developer", "Checkout My Work"]}
              multiTextDelay={1000}
              typeSpeed={40}
            />
          </h2>
          <p
            ...
            className="text-gray-500  md:max-w-lg text-2xl text-justify"
          >
            I'm Md. Asif Ferdous. I'm a passionate web developer. I like to work
            on web development using technologies like HTML, CSS, Javascript,
            React, Tailwind, Bootstrap, NodeJS, Mongodb, etc. You can checkout
            my resume.
          </p>
