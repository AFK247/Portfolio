        ...
        <div className='max-w-screen-lg m-auto mt-8'>
            {
                ...
                <div>
                    <section className='grid grid-cols-2 justify-center items-center gap-8 '>
                        <img className='hover:scale-110 duration-500 border rounded-lg p-4 w-[40vw] shadow-lg shadow-slate-600' src={lap} alt="" />
                        <img className='hover:scale-110 duration-500 border rounded-lg p-4 w-[40vw] shadow-lg shadow-slate-600' src={lap1} alt="" />
                        <img className='hover:scale-110 duration-500 border rounded-lg p-4 w-[40vw] shadow-lg shadow-slate-600' src={lap2} alt="" />
                    </section>
                    <div className='p-8 mb-8'>
                           <h2 className='text-4xl'>Features</h2>
                           <li>Used Laptop buy and sale  website with user authentication.</li>
                           <li>Buyer, Seller & Admin Route with individual dashboard.</li>
                           <li className='mb-4'>Stored data to MongoDB & implemented CRUD operation.</li>
